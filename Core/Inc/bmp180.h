...
#define BUFFER_PT_LENGTH				0x03
#define BUFFER_UT_LENGTH				0x02

#define BME_MMHG_Q0_20                  (uint32_t)7865
...
//extern BMP180_Calibration_TypeDef BMP180_Calibration; //for KEIL
