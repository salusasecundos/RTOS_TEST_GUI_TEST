...
clean-Core-2f-tasks:
	-$(RM) ./Core/tasks/bme280_task.cyclo ./Core/tasks/bme280_task.d ./Core/tasks/bme280_task.o ./Core/tasks/bme280_task.su ./Core/tasks/gui_task.cyclo ./Core/tasks/gui_task.d ./Core/tasks/gui_task.o ./Core/tasks/gui_task.su ./Core/tasks/led_task.cyclo ./Core/tasks/led_task.d ./Core/tasks/led_task.o ./Core/tasks/led_task.su ./Core/tasks/usb_task.cyclo ./Core/tasks/usb_task.d ./Core/tasks/usb_task.o ./Core/tasks/usb_task.su
