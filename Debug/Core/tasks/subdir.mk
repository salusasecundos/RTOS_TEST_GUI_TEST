...
Core/tasks/%.o Core/tasks/%.su: ../Core/tasks/%.c Core/tasks/subdir.mk
...
clean-Core-2f-tasks:
	-$(RM) ./Core/tasks/gui_task.d ./Core/tasks/gui_task.o ./Core/tasks/gui_task.su ./Core/tasks/led_task.d ./Core/tasks/led_task.o ./Core/tasks/led_task.su ./Core/tasks/usb_task.d ./Core/tasks/usb_task.o ./Core/tasks/usb_task.su
