...
C_SRCS += \
../Middlewares/tinyusb/hw/bsp/board.c 

OBJS += \
./Middlewares/tinyusb/hw/bsp/board.o 

C_DEPS += \
./Middlewares/tinyusb/hw/bsp/board.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/tinyusb/hw/bsp/%.o: ../Middlewares/tinyusb/hw/bsp/%.c Middlewares/tinyusb/hw/bsp/subdir.mk
...
clean: clean-Middlewares-2f-tinyusb-2f-hw-2f-bsp

clean-Middlewares-2f-tinyusb-2f-hw-2f-bsp:
	-$(RM) ./Middlewares/tinyusb/hw/bsp/board.d ./Middlewares/tinyusb/hw/bsp/board.o

.PHONY: clean-Middlewares-2f-tinyusb-2f-hw-2f-bsp
