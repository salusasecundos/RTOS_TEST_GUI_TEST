...
OBJS += \
./Middlewares/tinyusb/src/device/usbd.o \
./Middlewares/tinyusb/src/device/usbd_control.o 

C_DEPS += \
./Middlewares/tinyusb/src/device/usbd.d \
./Middlewares/tinyusb/src/device/usbd_control.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/tinyusb/src/device/%.o: ../Middlewares/tinyusb/src/device/%.c Middlewares/tinyusb/src/device/subdir.mk
...
clean: clean-Middlewares-2f-tinyusb-2f-src-2f-device

clean-Middlewares-2f-tinyusb-2f-src-2f-device:
	-$(RM) ./Middlewares/tinyusb/src/device/usbd.d ./Middlewares/tinyusb/src/device/usbd.o ./Middlewares/tinyusb/src/device/usbd_control.d ./Middlewares/tinyusb/src/device/usbd_control.o

.PHONY: clean-Middlewares-2f-tinyusb-2f-src-2f-device
