...
OBJS += \
./Middlewares/tinyusb/src/common/tusb_fifo.o 

C_DEPS += \
./Middlewares/tinyusb/src/common/tusb_fifo.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/tinyusb/src/common/%.o: ../Middlewares/tinyusb/src/common/%.c Middlewares/tinyusb/src/common/subdir.mk
...
clean: clean-Middlewares-2f-tinyusb-2f-src-2f-common

clean-Middlewares-2f-tinyusb-2f-src-2f-common:
	-$(RM) ./Middlewares/tinyusb/src/common/tusb_fifo.d ./Middlewares/tinyusb/src/common/tusb_fifo.o

.PHONY: clean-Middlewares-2f-tinyusb-2f-src-2f-common
