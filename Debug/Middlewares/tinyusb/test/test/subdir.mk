...
C_SRCS += \
../Middlewares/tinyusb/test/test/test_fifo.c 

OBJS += \
./Middlewares/tinyusb/test/test/test_fifo.o 

C_DEPS += \
./Middlewares/tinyusb/test/test/test_fifo.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/tinyusb/test/test/%.o: ../Middlewares/tinyusb/test/test/%.c Middlewares/tinyusb/test/test/subdir.mk
...
clean: clean-Middlewares-2f-tinyusb-2f-test-2f-test

clean-Middlewares-2f-tinyusb-2f-test-2f-test:
	-$(RM) ./Middlewares/tinyusb/test/test/test_fifo.d ./Middlewares/tinyusb/test/test/test_fifo.o

.PHONY: clean-Middlewares-2f-tinyusb-2f-test-2f-test
