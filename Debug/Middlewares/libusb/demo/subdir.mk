...
C_SRCS += \
../Middlewares/libusb/demo/cdc_loop.c \
../Middlewares/libusb/demo/cdc_startup.c 

OBJS += \
./Middlewares/libusb/demo/cdc_loop.o \
./Middlewares/libusb/demo/cdc_startup.o 

C_DEPS += \
./Middlewares/libusb/demo/cdc_loop.d \
./Middlewares/libusb/demo/cdc_startup.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/libusb/demo/%.o: ../Middlewares/libusb/demo/%.c Middlewares/libusb/demo/subdir.mk
...
clean: clean-Middlewares-2f-libusb-2f-demo

clean-Middlewares-2f-libusb-2f-demo:
	-$(RM) ./Middlewares/libusb/demo/cdc_loop.d ./Middlewares/libusb/demo/cdc_loop.o ./Middlewares/libusb/demo/cdc_startup.d ./Middlewares/libusb/demo/cdc_startup.o

.PHONY: clean-Middlewares-2f-libusb-2f-demo
